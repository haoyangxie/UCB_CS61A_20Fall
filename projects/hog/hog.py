...
def swine_align(player_score, opponent_score):
    ...
    if player_score == 0 or opponent_score == 0:
        ...
        return find_GCD(player_score,opponent_score)>=10
    # END PROBLEM 4a
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        ...
        if difference > running_high:
            print("{} point(s)! The most yet for Player {}".format(difference, who))
        return announce_highest(who, curr_score, max(running_high, difference))
    return say
    # END PROBLEM 7
...
def bacon_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    f_bacon = free_bacon(opponent_score)
    if f_bacon >= cutoff:
        return 0
    else:
        return num_rolls
